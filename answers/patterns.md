...
* Чистая функция - иммутабельная функция (не имеет права мутировать что-либо из внешнего мира), которая при одинаковых входных данных возвращает одинаковый результат соответственно.
