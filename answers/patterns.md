...
* Чистая функция - функция, которая при одинаковых входных данных возвращает одинаковый результат соответственно. Она иммутабельная (не имеет права мутировать что-либо из внешнего мира).
