...
* Переменная, обьявленная через var, имеет функциональную область видимости, а через let/const - блочную. Хороший пример, который часто любят давать на различие областей видимости var и let/const:
