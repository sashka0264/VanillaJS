...
## Event Loop
Event Loop - это механизм, который наблюдает за основным потоком и очередью коллбэков. Если основной поток пуст, то Event Loop берет первую задачу из очереди, помещая ее в основной поток на выполнение. 
