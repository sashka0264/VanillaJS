...
**Повтори Swagger, всплытие событий**
...
**Основные принципы:**
* DRI (Don’t repeat yourself - не дублируйся)
* KISS (keep it simple stupid - делай вещи проще)
* YAGNI (You aren't gonna need it - вам это не понадобится)
* Парето (20% усилий => 80 % результата, остальные 80% усилий => 20 % результата - надо уметь расставлять приориететы)
